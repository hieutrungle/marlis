...
##############################
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
# python ./marlis/run_marl_v1.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --env_id "shared-ap-v1" --group "SharedAP1" --name "TEST_no_compile" --ff_dim 128 --save_interval 5 --learning_starts 0 --total_timesteps 10 --n_runs 0 --init_learning_starts 4 --ep_len 2 --batch_size 4 --num_envs 2 --eval_ep_len 3 --no_eval True --seed 22 --wandb "offline"

python ./marlis/run_marl_v1.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --env_id "shared-ap-v1" --group "SharedAP1" --name "Default" --use_compile True